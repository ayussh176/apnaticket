...
export default function Booking() {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_API_BASE}/api/book`, form, {
                headers: {
